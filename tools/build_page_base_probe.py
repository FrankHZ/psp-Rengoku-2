...
PROBES = (
    ...
    },
    {
        ...
        "code": 0x021B,
        "candidates": (
            {"marker": "J", "child": 6, "cell": 8, "base": 0x0213, "formula": "contiguous"},
    ...
    },
    {
        ...
        "code": 0x023C,
        "candidates": (
            {"marker": "N", "child": 6, "cell": 41, "base": 0x0213, "formula": "contiguous"},
...
def write_readme(path: Path, output_root: Path) -> None:
    lines = [
        ...
        "",
        "This build patches `DATA001/0008` tutorial rows so multiple raw glyph-code",
        "bases can be checked in one run. Each displayed code has one or more",
        ...
        "",
        "Patched tutorial rows:",
        "",
        "- record `10`: title `BASE PROBE`",
        "- record `11`: subtitle `LOOK AT BODY ROWS`",

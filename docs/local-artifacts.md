...
| Path | Purpose |
| --- | --- |
| `local/rebuilt/combined_chs_v37_jp_story_data003_extracted/` | Current PPSSPP-ready broad CHS build plus JP-first DATA003/1089 story pass. |
| `local/work/combined_chs_v37_jp_story_data003/` | Current build metadata, stage config, glyph assignment, text payloads, and previews. |

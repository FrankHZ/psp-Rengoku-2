...
| Path | Purpose |
| --- | --- |
| `local/rebuilt/combined_chs_v42_review_feedback_extracted/` | Current PPSSPP-ready broad CHS build with latest reviewer feedback, reviewed equipment text, story glossary names, English attack attributes, DATA002 rough UI labels cleared, and the ANK halfwidth `1` footprint patch. |
...
| `local/work/font_digit1_probe/` | Current before/after evidence for the ANK halfwidth `1` footprint patch. |
